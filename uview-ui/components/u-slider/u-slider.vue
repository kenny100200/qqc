<template>
	<view class="u-slider" @tap="onClick" :class="[disabled ? 'u-slider--disabled' : '']" :style="{
		...
		<view class="bagView">
			<!-- <view :class="{activeColor:value>=0}"></view>
			<view :class="{activeColor:value>=25}"></view>
			<view :class="{activeColor:value>=50}"></view>
			<view :class="{activeColor:value>=75}" ></view> -->
			<!-- <view :class="{activeColor:value==100}" ></view> -->
			
			<view :style="{backgroundColor: value>=0?activeColor:''}"></view>
			<view :style="{backgroundColor: value>=25?activeColor:''}"></view>
			<view :style="{backgroundColor: value>=50?activeColor:''}"></view>
			<view :style="{backgroundColor: value>=75?activeColor:''}"></view>
			<view :style="{backgroundColor: value>=100?activeColor:''}" ></view>
		</view>
